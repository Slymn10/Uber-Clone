...
class SignupVC: UIViewController {
   ...
   private let accountTypeSegmentedControl: UISegmentedControl = {
      ...
      sc.tintColor = UIColor(white: 1, alpha: 0.85)
   ...
   private let alreadyHaveAccountButton: UIButton = {
      ...
      attributedTitle.append(NSAttributedString(string: "Login", attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 16), NSAttributedString.Key.foregroundColor: UIColor.systemPink]))
   ...
   func configureUI() {
      ...
      let stack = UIStackView(arrangedSubviews: [emailContainerView, fullnameContainerView, passwordContainerView, accountTypeContainerView, signupButton, orLabel, alreadyHaveAccountButton])
